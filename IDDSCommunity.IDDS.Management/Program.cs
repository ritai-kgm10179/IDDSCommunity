...
namespace IDDSCommunity.IDDS.Management;
...
class Program
{
    ...
    {
        Console.WriteLine(Strings.Get("IDDSCommunity.IDDS.Management - iddsadmin.exe"));
        ...
        Console.WriteLine(Strings.Get(""));
        Console.WriteLine(Strings.Get("(c) 2013-2016 IDDSCommunity is a trademark of isicore"));
    }
