...
public class VolumeLicenseManager
{
    ...
    /// <summary>
    /// Executes the check license operation.
    /// </summary>
    /// <param name="license">The license value.</param>
    ...
    /// Executes the check license operation.
    /// </summary>
    /// <param name="licenseFile">The license file value.</param>
    /// <returns><see langword="true"/> if the operation succeeds; otherwise, <see langword="false"/>.</returns>
    ...
    /// <returns>The get bytes result.</returns>
